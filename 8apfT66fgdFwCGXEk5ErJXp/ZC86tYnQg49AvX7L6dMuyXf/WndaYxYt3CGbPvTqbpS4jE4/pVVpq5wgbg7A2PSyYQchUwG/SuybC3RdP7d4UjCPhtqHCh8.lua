...
do -- Example UI
	local Window = library:AddWindow("Synapse X", {
		main_color = Color3.fromRGB(41, 74, 122),
		min_size = Vector2.new(600, 400),
		toggle_key = Enum.KeyCode.RightShift,
		can_resize = true,
	})
	local Tab = Window:AddTab("Execution")
	...
	do -- Elements
		...
		Console:Set("-- </> : Unique Dev#6143")

		local Horizontal1 = Tab:AddHorizontalAlignment()
		Horizontal1:AddButton("Execute", function()
			loadstring(Console:Get())()
		end)
		Horizontal1:AddButton("Clear", function()
			Console:Set("")
		end)
	end
